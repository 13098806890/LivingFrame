...
| `Segmentation/SegmentationAlgorithm.swift` | 两条抠图算法的统一枚举入口；Vision 入口当前隐藏 | — |
| `Segmentation/VisionPersonSegmenter.swift` | Vision 人物/通用前景实例掩码 | Vision |
